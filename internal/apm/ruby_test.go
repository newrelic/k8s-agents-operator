...
func TestRubyInjector_Inject(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			inst:           v1beta1.Instrumentation{Spec: v1beta1.InstrumentationSpec{Agent: v1beta1.Agent{Language: "ruby"}}},
		},
		{
			...
			inst: v1beta1.Instrumentation{Spec: v1beta1.InstrumentationSpec{Agent: v1beta1.Agent{Language: "ruby"}, LicenseKeySecret: "newrelic-key-secret"}},
		},
	}
