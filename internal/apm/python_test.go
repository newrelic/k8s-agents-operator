...
func TestPythonInjector_Language(t *testing.T) {
	require.Equal(t, "python", (&PythonInjector{}).Language())
}
...
func TestPythonInjector_Inject(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			inst:           v1beta1.Instrumentation{Spec: v1beta1.InstrumentationSpec{Agent: v1beta1.Agent{Language: "python"}}},
		},
		{
			...
			inst: v1beta1.Instrumentation{Spec: v1beta1.InstrumentationSpec{Agent: v1beta1.Agent{Language: "python"}, LicenseKeySecret: "newrelic-key-secret"}},
		},
	}
