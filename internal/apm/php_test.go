...
func TestPhpInjector_Inject(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			inst:           v1beta1.Instrumentation{Spec: v1beta1.InstrumentationSpec{Agent: v1beta1.Agent{Language: "php-8.3"}}},
		},
		{
			...
			inst: v1beta1.Instrumentation{Spec: v1beta1.InstrumentationSpec{Agent: v1beta1.Agent{Language: "php-8.3"}, LicenseKeySecret: "newrelic-key-secret"}},
		},
	}
