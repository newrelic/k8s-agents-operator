...
func main() {
	...
	if err = registerApiHealth(mgr, operatorNamespace, webhookValidatingConfigName, webhookMutatingConfigName, webhookSecretName, certManagerEnabled, certManagerCertName); err != nil {
...
func registerApiHealth(mgr manager.Manager, operatorNamespace, webhookValidatingConfigName, webhookMutatingConfigName, webhookSecretName string, certManagerEnabled bool, certManagerCertName string) error {
	// Create cached health checker with 5-second TTL
	cachedChecker := &cachedHealthChecker{
		check:    WebhookReadyCheck("webhook-ready", mgr, webhookValidatingConfigName, webhookMutatingConfigName, operatorNamespace, webhookSecretName, certManagerEnabled, certManagerCertName),
...
func WebhookReadyCheck(name string, mgr ctrl.Manager, webhookValidatingConfigName, webhookMutatingConfigName, webhookServiceNamespace, webhookSecretName string, certManagerEnabled bool, certManagerCertName string) func(req *http.Request) error {
